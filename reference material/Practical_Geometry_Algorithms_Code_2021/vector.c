...
// Type Conversions
Vector::Vector( Point P) {		// from origin to Point
	dimn = P.dimn; err = Enot;
	x = P.x; y = P.y; z = P.z;
}

Vector::Vector( Point P0, Point P1) {	// between two Points
	Vector v = P1 - P0;
	dimn = v.dimn; err = Enot;
	x = v.x; y = v.y; z = v.z;
}

Vector::Vector( Segment S) {	// segment vector
	Vector v = S.P1 - S.P0;
	dimn = v.dimn; err = Enot;
	x = v.x; y = v.y; z = v.z;
}
