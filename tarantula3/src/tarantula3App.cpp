...
class tarantula3App : public App {
public:
	void setup() override;
...
void tarantula3App::keyDown(KeyEvent event)
{
...
CINDER_APP(tarantula3App, RendererGl)
